...
function Navbar() {
    ...
    return (
        <div
            className={`fixed z-[900] w-full px-20 py-8 font-["Neue Montreal"] flex justify-between items-center transition-transform duration-500 ${showNavbar ? "translate-y-0" : "-translate-y-full"
                }`}
            style={{
